...
static char *font = "SourceCodePro-Light:pixelsize=15:antialias=true:autohint=true";
//static char *font2[] = { "Hack:pixelsize=15:antialias=true:autohint=true" };
static char *font2[] = { "fontawesome:pixelsize=15:antialias=true:autohint=true" };
